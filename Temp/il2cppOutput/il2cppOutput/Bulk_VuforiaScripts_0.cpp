...
IL_0025:
	{
		GameObject_tBD1244AD56B4E59AAD76E5E7C9282EC5CE434F0F * L_4 = __this->get_paddle_4();
		NullCheck(L_4);
		...
		__this->set_rend_5(L_5);
		Renderer_t0556D67DD582620D1F495627EDE30D03284151F4 * L_6 = __this->get_rend_5();
		MaterialU5BU5D_tD2350F98F2A1BB6C7A5FBFE1474DFC47331AB398* L_7 = __this->get_materials_6();
		NullCheck(L_7);
		int32_t L_8 = 0;
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_9 = (L_7)->GetAt(static_cast<il2cpp_array_size_t>(L_8));
		NullCheck(L_6);
		Renderer_set_sharedMaterial_mC94A354D9B0FCA081754A7CB51AEE5A9AD3946A3(L_6, L_9, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void DefaultTrackableEventHandler_OnTrackableStateChanged_m037F7353D61AC3E1BFEB93B7E51672578E783427 (DefaultTrackableEventHandler_t6997E0A19AC0FABC165FB7264F57DF2EDF4E8022 * __this, int32_t ___previousStatus0, int32_t ___newStatus1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		__this->set_m_PreviousStatus_8(L_0);
		int32_t L_1 = ___newStatus1;
		__this->set_m_NewStatus_9(L_1);
...
IL_0040:
	...
	{
		TrackableBehaviour_t579D75AAFEF7B2D69F4B68931D5A58074E80A7E4 * L_10 = __this->get_mTrackableBehaviour_7();
		NullCheck(L_10);
...
IL_0060:
	...
	{
		GameObject_tBD1244AD56B4E59AAD76E5E7C9282EC5CE434F0F * L_26 = __this->get_paddle_4();
		NullCheck(L_26);
		Renderer_t0556D67DD582620D1F495627EDE30D03284151F4 * L_27 = GameObject_GetComponent_TisRenderer_t0556D67DD582620D1F495627EDE30D03284151F4_mD202DDB933765AC3989986C7FA3C14E6E9A191EC(L_26, /*hidden argument*/GameObject_GetComponent_TisRenderer_t0556D67DD582620D1F495627EDE30D03284151F4_mD202DDB933765AC3989986C7FA3C14E6E9A191EC_RuntimeMethod_var);
		__this->set_rend_5(L_27);
		Renderer_t0556D67DD582620D1F495627EDE30D03284151F4 * L_28 = __this->get_rend_5();
		MaterialU5BU5D_tD2350F98F2A1BB6C7A5FBFE1474DFC47331AB398* L_29 = __this->get_materials_6();
		NullCheck(L_29);
		int32_t L_30 = 1;
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_31 = (L_29)->GetAt(static_cast<il2cpp_array_size_t>(L_30));
		NullCheck(L_28);
		Renderer_set_sharedMaterial_mC94A354D9B0FCA081754A7CB51AEE5A9AD3946A3(L_28, L_31, /*hidden argument*/NULL);
		return;
	}
}
